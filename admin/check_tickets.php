          ...
          <?php include ("includes/header.php") ?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <td style="font-weight:bold">Seat Booked</td>
                    <td style="font-weight:bold">Amount Paid </td>
                    </tr>

                    <?php
                    $result=mysqli_query($conn,"SELECT * FROM bookings WHERE shows='$title' order by id desc");
                    $i=0;
                    ...
                    <td><?php $seat_type=substr($rows['seat_type'],0,2);
