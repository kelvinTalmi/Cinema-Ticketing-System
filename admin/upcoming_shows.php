          ...
          <?php include ("includes/header.php") ?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container">
<center><h3>UPCOMING SHOWS</h3></center><br>
...
<?php
$result=mysqli_query($conn,"SELECT * FROM shows where status=1");
$i=0;
...
<td><a href="show_details.php?id=<?php echo $rows['id']  ?>">Details</a>  </td>
