...
$snack=$_POST['snack'];
$price=$_POST['price'];
 $result=mysqli_query($conn,"INSERT INTO snacks_drinks(item,price)VALUES('$snack','$price')");
          ...
          <?php include ("includes/header.php") ?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="card">
                    <center><div class="card-header"><H5>Add Snacks and Drinks</h5></div></center>
                    <div class="card-body">
                    <form method="post">
                    <label>Snack && drinks</label>
                    <input type="text" class="form-control" name="snack" required>
