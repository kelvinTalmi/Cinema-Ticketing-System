...
if(isset($_POST['delete'])){
  ...
  window.location.href='upcoming_shows.php';
...
$update_status=mysqli_query($conn,"UPDATE shows set status=0 WHERE id=$show_id");
if($update_status){
...
<option value="<?php echo $rows['rating'] ?>"><?php echo $rows['rating'] ?> </option>
                        ...
                        <label>Date to feature</label>
                          ...
                          <label>VVIP Charges</label>
                            ...
                            <button name="update_status" class="btn btn-success">Outdate</button>
