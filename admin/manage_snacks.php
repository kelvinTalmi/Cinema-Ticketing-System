...
<?php
$result=mysqli_query($conn,"SELECT * FROM snacks_drinks");
$i=0;
...
<td>Ksh  <?php  echo $rows['price']  ?></td>
<td><a href="edit_snack.php?id=<?php  echo $rows['id']?>">Edit</a> &nbsp;&nbsp;&nbsp;

<a href="delete_snacks.php?id=<?php  echo $rows['id']?>">Delete</a>
